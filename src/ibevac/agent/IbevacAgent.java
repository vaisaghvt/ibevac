...
public class IbevacAgent extends MovingAgent implements Steppable, Proxiable {
    ...
    private final DescriptiveStatistics speedStat = new DescriptiveStatistics();
...
//        preferredSpeed = EvacConstants.AGENT_MAX_SPEED;
    ...
    public boolean isGoalReached() {
        return planner.getChosenGoal() == null || getPosition().distance(planner.getChosenGoal()) < 3 * getDiameter();
    }
