...
import ibevac.agent.planner.states.ManagementDefault;
 ...
 */
public class ManagementPlanner implements Planner {
...
//    };
    ...
    public ManagementPlanner(IbevacAgent agent, EventKnowledgeModule eventKnowledge,
...
//		this.eventKnowledge = eventKnowledge;
        ...
        state = new ManagementDefault(this, agent);
